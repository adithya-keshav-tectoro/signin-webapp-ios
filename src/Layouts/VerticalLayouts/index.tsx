...
const VerticalLayout = (props: any) => {
    ...
    useEffect(() => {
        ...
        const initMenu = () => {
            let pathName: any = process.env.PUBLIC_URL + path;
            pathName = pathName?.split('/').filter((v: any) => v !== '');
            ...
            const matchingMenuItem = itemsArray.find((x) => {
                const path = x.href?.split('/').filter((v: any) => v !== '');
                return path[3] === pathName[0];
            });
            if (matchingMenuItem) {
                ...
                return (
                    <React.Fragment key={key}>
                        ...
                        {item['isHeader'] ? (
                            ...
                            <li className="nav-item">
                                <Link className="nav-link menu-link active" to={item.link ? item.link : '/#'}>
